...
// Legacy window controls padding — kept for backward compatibility with
// the fallback branch in `desktop-window.ts`. Not used on macOS (traffic
// lights are handled by DESKTOP_TRAFFIC_LIGHT_* above).
