...
const existingProject = join(await mkdtemp(join(tmpdir(), "polyhive-open-project-")), "project");
...
const previousDesktopCli = process.env.POLYHIVE_DESKTOP_CLI;
process.env.POLYHIVE_DESKTOP_CLI = "1";
...
process.env.POLYHIVE_DESKTOP_CLI = previousDesktopCli;
