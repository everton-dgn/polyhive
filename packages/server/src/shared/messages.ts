...
/**
 * @deprecated Push notifications were removed in the macOS + web fork.
 * Schema is kept so old clients that still emit `register_push_token`
 * pass validation and are silently ignored (no switch handler is registered).
 * See CLAUDE.md backward-compat rules.
 */
export const RegisterPushTokenMessageSchema = z
  .object({
