...
import { ArrowUp, Mic, MicOff, CornerDownLeft, Plus, Square } from "lucide-react";
...
const MIN_INPUT_HEIGHT = MIN_INPUT_HEIGHT_DESKTOP;
...
export const MessageInput = forwardRef<MessageInputRef, MessageInputProps>(function MessageInput(
  ...
  const buttonIconSize = theme.iconSize.md;
  ...
  const inputScrollbar = useWebElementScrollbar(webTextareaRef, {
    enabled: inputHeight >= MAX_INPUT_HEIGHT,
  });
  ...
  function handleContentSizeChange(
    _event: NativeSyntheticEvent<TextInputContentSizeChangeEventData>,
  ) {
    // web-only: height is driven by the textarea itself, not RN layout events
  }
  ...
  const shouldHandleDesktopSubmit = true;
  ...
  function handleDesktopKeyPress(event: WebTextInputKeyPressEvent) {
    ...
    // Cmd+Enter (macOS) / Ctrl+Enter (other browsers): alternate action
    ...
    <View ref={rootRef} style={styles.container} testID="message-input-root">
      ...
      >
        ...
        <View style={styles.textInputScrollWrapper}>
          ...
          />
          {inputScrollbar}
          {isPaneFocused && !isInputFocused && !value && focusInputKeys ? (
