      ...
      {providerOptions && providerOptions.length > 0 ? (
        <>
          <Pressable
            ...
            accessibilityLabel={`Select agent provider (${displayProvider})`}
          ...
          <Tooltip delayDuration={0} enabledOnDesktop enabledOnMobile={false}>
            <TooltipTrigger asChild triggerRefProp="ref">
              <Pressable
                ...
                style={({ pressed, hovered }) => [
                  isCompact ? styles.modeBadge : styles.modeIconBadge,
                  hovered && styles.modeBadgeHovered,
              ...
              >
                ...
                {isCompact ? <Text style={styles.modeBadgeText}>{displayMode}</Text> : null}
              </Pressable>
            </TooltipTrigger>
            <TooltipContent side="top" align="center" offset={8}>
            ...
            >
              <TooltipTrigger asChild triggerRefProp="ref">
                ...
                >
                  ...
                  />
                  {isCompact ? <Text style={styles.modeBadgeText}>{feature.label}</Text> : null}
                </Pressable>
              </TooltipTrigger>
              <TooltipContent side="top" align="center" offset={8}>
