...
export function Combobox({
  ...
  const isDesktopAboveSearch = !isMobile && effectiveOptionsPosition === "above-search";
  ...
  const { refs, floatingStyles, update } = useFloating({
    ...
    middleware,
    elements: {
      reference: (anchorRef.current as unknown as HTMLElement | null) ?? undefined,
    },
  });
  ...
  const desktopPositionStyle = isDesktopAboveSearch
    ...
    : useMeasuredTopStartPosition
      ...
      : (floatingStyles as unknown as ViewStyle);
  ...
  }, [handleDesktopKey, isMobile, isOpen]);
  ...
  return (
    <Modal transparent animationType="none" visible={isOpen} onRequestClose={handleClose}>
      <View collapsable={false} style={styles.desktopOverlay}>
        ...
        <Animated.View
          ...
          ref={(node) => refs.setFloating(node as unknown as HTMLElement | null)}
          collapsable={false}
          onLayout={(event) => {
