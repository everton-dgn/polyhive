...
import { GITHUB_WEB_BASE, SITE_HOST } from "~/fork-identity";
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-white/60 leading-relaxed">
          Paseo has three main pieces: the daemon is the local macOS server that manages your
          agents, the web client runs in desktop and mobile browsers, and the CLI is the terminal
      ...
      <section className="space-y-4">
        ...
        <p className="text-white/60">
          Use this path for headless Macs or remote macOS machines where you want the daemon running
