  ...
  try {
    ...
    const stop = async () => {
      ...
      await new Promise<void>((resolve) => {
        ...
        // Force-close idle keep-alive connections so close() doesn't block
        // on sockets that won't receive more traffic (flaky on CI runners).
