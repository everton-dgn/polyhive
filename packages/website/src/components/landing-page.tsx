  ...
  return (
    <>
      <div className="relative">
        ...
        {/* Mockup - inside hero so it can overflow into the next section */}
        <motion.div
...
function SelfHostedDiagram() {
  ...
  const hosts = ["MacBook Pro", "Mac mini", "Mac Studio"];
...
function SelfHostedSection() {
  return (
    <FeatureSection
      ...
      description="Run agents on your Mac and control them from the macOS app, any browser, or the CLI with a direct connection or an E2E encrypted relay."
    >
      <SelfHostedDiagram />
    </FeatureSection>
  );
...
function DownloadButton() {
  ...
  const primary = options.find((o) => o.platform === detectedPlatform) ?? options[0];
    ...
    <div ref={containerRef} className="flex flex-col items-center pt-4 pb-16 gap-20">
      ...
      >
        ...
        <p className="text-sm text-white/50 text-center">
          Any mobile browser gives you the same web client.
        </p>
      </motion.div>
...
function CLISection() {
  ...
  return (
    <FeatureSection
      ...
      description="Everything you can do in the web client, you can do from the terminal."
    >
