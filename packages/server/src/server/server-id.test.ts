...
function tmpHome(): string {
  return mkdtempSync(path.join(tmpdir(), "polyhive-server-id-"));
}
...
describe("getOrCreateServerId", () => {
  ...
  beforeEach(() => {
    ...
    delete process.env.POLYHIVE_SERVER_ID;
    home = tmpHome();
  });
  ...
  it("creates and persists a stable id per POLYHIVE_HOME", () => {
  ...
  it("respects and persists POLYHIVE_SERVER_ID override", () => {
