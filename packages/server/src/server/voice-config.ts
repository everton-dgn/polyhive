const VOICE_PROMPT_BLOCK_START = "<polyhive_voice_mode>";
const VOICE_PROMPT_BLOCK_END = "</polyhive_voice_mode>";

const VOICE_AGENT_SYSTEM_INSTRUCTION = [
  "PolyHive voice mode is now on.",
  "You are the PolyHive voice assistant.",
...
const VOICE_AGENT_DISABLED_INSTRUCTION = [
  "PolyHive voice mode is now off.",
  "Ignore any earlier PolyHive voice mode instructions in this thread.",
].join(" ");
