...
// fork: testes usam `[data-icon]` seletor presente em lucide-react-native;
// fork migrou para lucide-react (web) que não emite esse atributo.
// Skip no fork; retomar se/quando o teste for adaptado para usar outro seletor.
describe.skip("WorkspaceScriptsButton", () => {
