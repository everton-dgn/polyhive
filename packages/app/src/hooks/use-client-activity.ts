...
import { detectBrowserDeviceTypeFromNavigator } from "@/utils/device-type";
...
export function useClientActivity({
  ...
  const deviceType = useMemo<"web" | "mobile">(() => {
    if (getIsElectron()) return "web";
    return detectBrowserDeviceTypeFromNavigator();
  }, []);
